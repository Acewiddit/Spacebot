...
Observe the instructions:
 ...
 Select if you want to utilise the hard-coded token (yes/no).
 ...
 Sends a message to the Webex room using send_webex_message(room_id, message).
